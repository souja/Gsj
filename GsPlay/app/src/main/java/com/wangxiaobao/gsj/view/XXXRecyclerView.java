...
import com.wangxiaobao.gsj.adapter.HatShoe;
...
public class XXXRecyclerView extends RecyclerView implements HatShoe {
    ...
    private static final int LAYOUT_MANAGER_LINEAR = 0x01;
    private static final int LAYOUT_MANAGER_GRID = 0x02;
    private static final int LAYOUT_MANAGER_STAGGERED_GRID = 0x03;
    private static final String TAG = "XXXRecyclerView";

    private boolean mLoadable = true;
    private boolean mIsLoading = false;
    private @LAYOUT_MANAGER_TYPE
    ...
    private View createDefaultLoadMoreView() {
        return View.inflate(getContext(), R.layout.load_more_layout, null);
    }
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (!loadMoreIsShow() && !mIsLoading && (totalItemCount - visibleItemCount) <=
                ...
                mIsLoading = true;
                    ...
                    (mTouchThis ? firstPosition : firstPosition + 1)) {
                setLoadMoreShow(false);
//                CommonUtil.showShortToast("没有更多了～");
            }
        }
    }
    ...
    @IntDef({LAYOUT_MANAGER_LINEAR, LAYOUT_MANAGER_GRID, LAYOUT_MANAGER_STAGGERED_GRID})
