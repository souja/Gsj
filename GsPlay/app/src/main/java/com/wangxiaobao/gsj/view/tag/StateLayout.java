...
//    ColorStateList mTextColorStateList;
    ...
    protected int mNormalStrokeColor = 0;
    private int mPressedStrokeColor = 0;
    private int mUnableStrokeColor = 0;

    //background color
    protected int mNormalBackgroundColor = 0;
    protected int mPressedBackgroundColor = 0;
...
//        setSelectedTextColor(mTextColorStateList);
//    }
